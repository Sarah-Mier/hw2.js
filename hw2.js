    ...
    let balance = 0
      for (let i=0;i<blockchain.length;i++) {
        if (blockchain[i].fromUser === "user") {
          balance = balance - blockchain[i].fromUser.amount
        }
        else if (blockchain[i].toUser === "user") {
          balance = balance + blockchain[i].toUser.amount
        }
    }
    return balance
}
// I can't figure out how to make the amounts add or correctly recall the actual amount here. I will attend office hours.
//
// // Ben's code
//
